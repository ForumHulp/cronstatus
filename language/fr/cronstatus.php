...
$lang = array_merge($lang, array(
	...
	'ACP_CRON_STATUS_EXPLAIN'			=> 'Depuis cette page il est possible d’avoir une vue d’ensemble sur le statut des tâches du Cron. Une tâche marquée en rouge signifie que celle-ci n’a jamais été exécutée ou rencontre un problème. Un verrou rouge signifie que celle-ci est en cours d’exécution, ou que celle-ci est verrouillée par le gestionnaire du Cron et bloque d’autres tâches.<br /><br />Réinitialiser le verrouillage du Cron en cliquant sur le verrou.<br /><br />Exécuter une tâche disponible en cliquant sur « Exécuter la tâche maintenant » situé à droite de son nom.<br /><br />L’indication « Automatique » concerne une tâche qui possède sa propre gestion de sa fréquence d’exécution et qui ne peut être prise en charge par l’extension « Cron Status ».',
